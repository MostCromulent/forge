...
function freshUi(): UiState {
  return {
    ...
    stopsOpen: false, optionsOpen: false, gameMenu: null, volumeOpen: false, renaming: false, picker: null, browse: null, importer: null, spectate: false, hover: null, faceIndex: 0, cardText: false,
