...
/**
 * Standalone CLI for analyzing game log files.
 * Works with forge.log, ServerOutput.txt, ClientOutput.txt, or batch log directories.
 *
 * Usage:
 *   java -cp <classpath> forge.net.analysis.LogAnalyzerCli [options] <file|dir>...
 *
 * Options:
...
public class LogAnalyzerCli {
    ...
    public static void main(String[] args) {
        if (args.length == 0) {
            ...
            System.err.println("  -o <file>  Write report to file (default: stdout)");
            System.exit(1);
        }
